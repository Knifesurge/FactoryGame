package com.knifesurge.display;
...
import com.knifesurge.handlers.ControllerInputHandler;
import com.knifesurge.handlers.KeyInputHandler;
import com.knifesurge.handlers.MouseInputHandler;

/**
 * <strong>Project:</strong> FactoryGame <br>
 * <strong>File:</strong> Display.java <br>
 * 
 * <p>
...
public final class Display {
	...
	public static void create(String title, int width, int height, boolean vsync)
	{
		...
		System.out.println("Create GLFWKeyCallback");
		glfwSetKeyCallback(window, keyCallback = new KeyInputHandler());
		glfwSetMouseButtonCallback(window, mouseCallback = new MouseInputHandler());
		glfwSetJoystickCallback(controllerCallback = new ControllerInputHandler());
